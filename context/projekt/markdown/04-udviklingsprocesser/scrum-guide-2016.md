...
| Felt | Værdi |
|---|---|
| **Lektion** | L8–L9 — Udviklingsprocesser og Kanban (læsestof om Scrum) |
| **Kursus** | SWISE-01 Indledende System Engineering |
| **Kilde** | `2016-Scrum-Guide-US.pdf` (17 sider) |
| **Type** | artikel |
| **Emner dækket** | Definition of Scrum; Scrum Theory (transparency, inspection, adaptation); Scrum Values; The Scrum Team (Product Owner, Development Team, Scrum Master); Scrum Events (Sprint, Sprint Planning, Daily Scrum, Sprint Review, Sprint Retrospective); Scrum Artifacts (Product Backlog, Sprint Backlog, Increment); Artifact Transparency; Definition of "Done" |

---

**The Scrum Guide™ — The Definitive Guide to Scrum: The Rules of the Game.** July 2016. Developed and sustained by Ken Schwaber and Jeff Sutherland.

Licens: ©2016 Scrum.Org and ScrumInc. Offered for license under the Attribution Share-Alike license of Creative Commons (http://creativecommons.org/licenses/by-sa/4.0/). Teksten nedenfor er guidens fulde ordlyd, struktureret efter dens egne overskrifter. Sidehenvisninger er til originalen (`> s. N`).
...
Oversigt over time-boxes (for en Sprint på én måned; kortere Sprints giver normalt kortere events):

| Event | Time-box | Deltagere |
|---|---|---|
| Sprint | ≤ 1 kalendermåned (fast, kan ikke forkortes/forlænges) | Scrum Team |
| Sprint Planning | ≤ 8 timer | Hele Scrum Team |
| Daily Scrum | 15 minutter | Kun Development Team |
| Sprint Review | ≤ 4 timer | Scrum Team + key stakeholders inviteret af Product Owner |
| Sprint Retrospective | ≤ 3 timer | Scrum Team (Scrum Master som peer) |

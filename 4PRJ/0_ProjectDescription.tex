...
\begin{center}
\begin{tabular}{@{}ll@{}}
\textbf{Course:}     & SW4PRJ4 - Project 4, 4th semester Software Engineering \\
\textbf{Semester:}   & Autumn semester 2026 \\
\textbf{Group:}      & \textit{3} \\
\textbf{Supervisor:} & \textit{Not assigned} \\
\end{tabular}
\end{center}
\hrule
...
\subsection*{Rich Image}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{assets/images/rich-image.png}
    \caption{Rich image}
    \label{fig:rich-image}
\end{figure}
\end{document}